                ...
                <div class="row mb-2">
                    <div class="col-md-6 col-sm-6 col-12">
                        <div class="info-box shadow-lg">
                            <span class="info-box-icon bg-maroon"><i class="bi bi-badge-tm"></i></span>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <!-- /.card-body -->
                            @include('back.marques.form')
                            @include('back.marques.show')
                        </div>
                        <!-- /.card -->
                    </div>
                    <!-- /.col -->
...
@push('scripts')
    ...
    <script>
        ...
        function add() {
            ...
            $('#ajax-form').attr("action", "{{ route('marques.store') }}");
            $('#formulaire-modal').find('.modal-title').text('Créer une nouvelle marque');
        }
        ...
        function addForm() {
            ...
            $('.modal-title').text('Nouvelle marque');
            $('#id').val('');
        ...
        function showData(id){
            ...
            $.ajax({
                ...
                success: function(row){
                    ...
                    $('.modal-title-show').text('Visualisation marque');

                    $('#id-show').val(row.data.id);
                    /* $('.info-box-number').html(data.role); */
                    $('#marque-show').val(row.data.marque);
                },
                error: function(){
        ...
        function editData(id){
            ...
            $.ajax({
                ...
                success: function(row){
                    ...
                    console.log(data);
                    $('#modal-form').modal('show');
                    $('.modal-title').text('Modification marque');
