                  ...
                  <div class="col-sm-8 col-12">
                    <div class="card card-maroon">
                      <div class="card-header">
                        <h3 class="card-title">Detail de l'achat</h3>
                      </div>
                      ...
                      <div class="card-body">
                        ...
                        <div class="row">
                          ...
                          <div class="col-sm-4 col-6">
                            <div class="form-group">
                              <label for="dv_quantite">Quantité attendue</label>
                          ...
                          <div class="col-sm-4 col-6">
                            <div class="form-group">
                              <label for="dv_livraison">Livraison</label>
                              <input type="number" class="form-control rounded-0" id="dv_livraison" />
                            </div>
                          </div>
                          
                          <div class="col-sm-4 col-6">
                            <div class="form-group">
                              <label for="dv_livre">Livrée</label>
                              <input type="number" class="form-control rounded-0" id="dv_livre" readonly />
                            </div>
                          </div>

                          <div class="col-sm-4 col-6">
                            <div class="form-group">
                              <label for="dv_restant">Restant</label>
                              <input type="number" class="form-control rounded-0" id="dv_restant" readonly />
                            </div>
                          </div>
                        </div>
                      </div>
