                ...
                <div class="row mb-2">
                    <div class="col-md-6 col-sm-6 col-12">
                        <div class="info-box shadow-lg">
                            <span class="info-box-icon bg-maroon">{{-- <i class="bi bi-box"></i> --}}<i class="bi bi-upc-scan"></i></span>

                            <div class="info-box-content">
                                <span class="info-box-text">Ingredients</span>
                                <span class="info-box-number">{{ number_format($nb_ingredients, 0, ",",".") }}</span>
                            </div>
                            <!-- /.info-box-content -->
                        </div>
                        <!-- /.info-box -->
                    ...
                    <div class="col-md-12 col-sm-12 col-12 d-flex">
                        <button type="button" class="btn btn-flat btn-primary ml-auto" onclick="addForm()">
                            <i class="bi bi-plus-lg"></i> Ajouter un ingredient
                        </button>
                    </div>
                </div>
                <!-- /.container-fluid -->
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <!-- /.card-body -->
                            @include('back.ingredients.form')
                            @include('back.ingredients.show')
                        </div>
                        <!-- /.card -->
                    </div>
                    <!-- /.col -->
...
<script>
    ...
    <script>
        ...
        function addForm() {
            ...
            $('.modal-title').text('Nouvel ingredient');
            $('#id').val('');
        ...
        function showData(id){
            $.ajax({
                ...
                success: function(row){
                    ...
                    $('.modal-title-show').text('Visualisation ingredient');

                    $('#id-show').val(row.data.id);
                    /* $('.info-box-number').html(data.role); */
                    $('#ingredient-show').html(row.data.ingredient);
        ...
        function editData(id){
            ...
            $.ajax({
                ...
                success: function(row){
                    ...
                    console.log(data);
                    $('#modal-form').modal('show');
                    $('.modal-title').text('Modification ingredient');
                    $('#insertbtn').text(' Modifier');

                    $('#id').val(data.id);
                    $('#ingredient').val(row.data.ingredient);
        ...
        function deleteData(id) {
            ...
            Swal.fire({
                title: 'Etes vous sûr ?',
                text: "Voulez-vous vraiment supprimer cet ingredient ?",
                icon: 'warning',
