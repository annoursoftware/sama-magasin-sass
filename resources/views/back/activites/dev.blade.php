                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <!-- /.card-body -->
                            @include('back.activites.form')
                            @include('back.activites.show')
                        </div>
                        <!-- /.card -->
                    </div>
                    <!-- /.col -->
...
<script>
    ...
    <script>
        ...
        function addForm() {
            ...
            $('.modal-title').text('Nouvelle activité');
            $('#id').val('');
        ...
        $('#formulaire').submit(function (e) {
            ...
            var id = $('#id').val();
            if(save_method == 'add')
            url = "{{ url('api/activites') }}";
            else
            url = "{{ url('api/activites') . '/' }}" + id;
        ...
        function showData(id){
            $.ajax({
                ...
                success: function(row){
                    ...
                    $('.modal-title-show').text('Visualisation activité');

                    $('#id-show').val(row.data.id);
                    /* $('.info-box-number').html(data.role); */
                    $('#activite-show').html(row.data.activite);
        ...
        function editData(id){
            ...
            $.ajax({
                ...
                success: function(row){
                    ...
                    $('#id').val(data.id);
                    $('#activite').val(row.data.activite);
                    $('#montant').val(row.data.montant);
