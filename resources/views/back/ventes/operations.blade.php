                ...
                <div class="row mb-2">
                    <div class="col-md-2 col-sm-6 col-12">
                        <div class="info-box shadow-lg">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-number">{{ number_format($nb_ventes, 0, ",",".") }}</span>
                            </div>
                            <!-- /.info-box-content -->
                        </div>
                        <!-- /.info-box -->
                    ...
                    <div class="col-md-2 col-sm-6 col-12">
                        <div class="info-box shadow-lg">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-number">{{ number_format($cumul_article_detail_ventes, 0, ",",".") }}</span>
                            </div>
                            <!-- /.info-box-content -->
                        </div>
                        <!-- /.info-box -->
                    ...
                    <div class="col-md-2 col-sm-6 col-12">
                        <div class="info-box shadow-lg">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-number">{{ number_format($cumul_quantite_detail_ventes, 0, ",",".") }}</span>
                            </div>
                            <!-- /.info-box-content -->
                        </div>
                        <!-- /.info-box -->
                    ...
                    <div class="col-md-3 col-sm-6 col-12">
                        <div class="info-box shadow-lg">
                            ...
                            <div class="info-box-content">
                                <span class="info-box-text">Montant des ventes</span>
                                <span class="info-box-number">{{ number_format($mt_ventes, 0, ",",".") }} FCFA</span>
                            </div>
                            <!-- /.info-box-content -->
                        </div>
                        <!-- /.info-box -->
    ...
    <script>
        $(function () {
            var table = $('#table').DataTable({
                ...
                autoWidth: true,
                responsive: true, */
                ajax: "{{ route('operations-de-ventes') }}",
                columns: [
                    /* {data: 'id', name: 'id'}, */
