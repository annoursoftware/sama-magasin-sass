    ...
    <div class="container" style="margin-top: 5px">
        ...
        <div class="row" id="test5" style="margin-top: 10px">
            <div class="col-xs-12 text-center">
                <h5>
                    <strong class="text-uppercase">Dettes</strong>
                </h5>
            </div>
        </div>
                        ...
                        <tbody id="test2">
                            ...
                            <?php $i++ ?>
                                <tr>
                                    ...
                                    <td>{{ $r->n_prestat }}</td>
                                    <td>{{ $r->recepteur }}</td>
                                    <td>{{ $r->telephone_primaire }}</td>
                                    <td class="text-center">{{ number_format(($r->cumul) , 0, ",",".")}} FCFA</td>
                                    <td class="text-center">{{ number_format(($r->montant_decaisse) , 0, ",",".")}} FCFA</td>
                                    <td class="text-center">{{ number_format(($r->restant) , 0, ",",".")}} FCFA</td>
                                </tr>
                            @endforeach
                        </tbody>
            ...
            <div class="col-xs-5 pull-left">
                ...
                <table id="" class="table table-bordered">
                    ...
                    <tbody>
                        <tr>
                            <td class="">Achat</td>
                            <td class="text-center">{{ number_format(($achat) , 0, ",",".")}} FCFA</td>
                        </tr>
                        <tr>
