            ...
            <div class="container">
                ...
                <div class="row mb-2">
                    <div class="col-md-3 col-sm-6 col-12">
                        <div class="info-box shadow-lg">
                            ...
                            <div class="info-box-content">
                                <span class="info-box-text">Creances</span>
                    ...
                    <div class="col-md-12 col-sm-12 col-12 d-flex">
                        <a href="{{ route('recouvrement.etat.creances') }}" type="button"
                            class="btn btn-flat btn-danger ml-auto" target="_blank">
                            <i class="bi bi-filetype-pdf"></i> Impression des creances
                        </a>
                    </div>
                </div>
                <!-- /.container-fluid -->
    ...
    <script>
        $(function() {
            var table = $('#table').DataTable({
                ...
                autoWidth: true,
                responsive: true, */
                ajax: "{{ route('recouvrement.creances') }}",
                columns: [{
                        data: 'num_contrat',
                        name: 'num_contrat'
                    },
                    ...
                    {
                        data: 'num_encaissement',
                        name: 'num_encaissement'
                    },
                    {
                        data: 'montant_encaisse',
                        name: 'montant_encaisse',
                        render: $.fn.dataTable.render.number('.', ',', 0)
                    },
                    {
                        data: 'montant_restant_a_encaisser',
                        name: 'montant_restant_a_encaisser',
                        render: $.fn.dataTable.render.number('.', ',', 0)
                    },
                    /* {
                        data: 'action',
