      ...
      <div class="modal-content">
        ...
        <form id="formulaire" class="form-horizontal" method="POST" action="{{ url('api/users') }}" validate="true">
                ...
                <div class="row mt-4">
                    <div class="col-sm-9">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control rounded-0" name="fournisseur" id="fournisseur" required placeholder="Le fournisseur" />
                        </div>
                    </div>
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                          ...
                          <select class="custom-select rounded-0" id="type" name="type" required>
                            ...
                            <option value="i">Informel</option>
                            <option value="f">Formel</option>
                          </select>
                        </div>
                    </div>
            ...
            <div class="modal-footer justify-content-between">
                ...
                <button type="submit" class="btn btn-outline-primary bi bi-floppy-fill" id="nv_fournisseur"> </button>
            </div>
        </form>
      </div>
      <!-- /.modal-content -->
