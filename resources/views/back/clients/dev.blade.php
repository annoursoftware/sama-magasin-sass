                    ...
                    <div class="col-md-6 col-sm-6 col-12">
                        <div class="info-box shadow-lg">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-number">{{ number_format($nb_clients, 0, ",",".") }}</span>
                            </div>
                            <!-- /.info-box-content -->
                        </div>
                        <!-- /.info-box -->
                    ...
                    <div class="col-md-6 col-sm-6 col-12">
                        <div class="info-box shadow-lg">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-number">{{ number_format(($mt_ventes+$mt_prestations), 0, ",",".") }}</span>
                            </div>
                            <!-- /.info-box-content -->
                        </div>
                        <!-- /.info-box -->
        ...
        function showData(id){
            $.ajax({
                ...
                success: function(row){
                    ...
                    $('.modal-title-show').text('Visualisation client');

                    $('#id-show').val(row.data.id);
                    /* $('.info-box-number').html(data.role); */
                    $('#client-show').html(row.data.client);
        ...
        function editData(id){
            ...
            $.ajax({
                ...
                success: function(row){
                    ...
                    $('#nv_client').text(' Modifier');

                    $('#id').val(data.id);
                    $('#client').val(row.data.client);
