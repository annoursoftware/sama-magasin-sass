                ...
                <div class="row mb-2">
                    ...
                    <div class="col-md-4 col-sm-6 col-12">
                        <div class="info-box shadow-lg">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-number">{{ number_format($mt_prestations, 0, ",",".") }} F.CFA</span>
                            </div>
                            <!-- /.info-box-content -->
                        </div>
                        <!-- /.info-box -->
                    ...
                    <div class="col-md-3 col-sm-6 col-12">
                        <div class="info-box shadow-lg">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-number">{{ number_format($moyenne_prestations, 0, ",",".") }} F.CFA</span>
                            </div>
                            <!-- /.info-box-content -->
                        </div>
                        <!-- /.info-box -->
                    ...
                    <div class="col-md-3 col-sm-6 col-12">
                        <div class="info-box shadow-lg">
                            ...
                            <div class="info-box-content">
                                <span class="info-box-text">Meilleure prestation</span>
                                <span class="info-box-number">{{ number_format($best_prestation, 0, ",",".") }} F.CFA</span>
                            </div>
                            <!-- /.info-box-content -->
                        </div>
                        <!-- /.info-box -->
