                        ...
                        <div class="col-sm-12">
                            <div class="card card-maroon">
                                <div class="card-header">
                                    <h3 class="card-title">Etapes de Prestation</h3>
                                </div>
                                
                                <input type="hidden" name="user_id" value="{{ Auth::id() }}">
                                <input type="hidden" id="status_prestation" name="status_prestation" value="d">
                                        ...
                                        <div class="bs-stepper-header" role="tablist">
                                            ...
                                            <div class="step" data-target="#detail-part">
                                                <button type="button" class="step-trigger" role="tab" aria-controls="detail-part"
                                                    ...
                                                    <span class="bs-stepper-label">Details Devis</span>
                                                </button>
                                            </div>
                                        </div>
                                        {{-- Header --}}
                                            ...
                                            <div id="detail-part" class="content" role="tabpanel"
                                                ...
                                                <div class="row mt-1">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="card card-maroon">
                                                            <div class="card-header">
                                                                <h3 class="card-title">Details Devis</h3>
                                                            </div>
                                                            <div class="card-body">
                                                                <div class="row">
                                                                    <div class="col-sm-12">
                                                                                ...
                                                                                <tfooter>
                                                                                    ...
                                                                                    <tr class="text-black text-sm">
                                                                                        <th class="text-center" colspan="2">
                                                                                            <input type="number" class="form-control" name="remise" id="remise" placeholder="La Remise en %" />
                                                                                        </th>
                                                                                    </tr>
                                                                                    <tr style="background-color:rgb(243, 64, 118)" class="text-white text-sm">
