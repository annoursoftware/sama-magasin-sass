...
@section('title', 'Prestations | Tracking Devis')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Tracking Devis</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ route('dev.dashboard') }}">Tableau de bord</a></li>
                            <li class="breadcrumb-item active">Prestations | Tracking Devis</li>
                        </ol>
                    </div>
                </div>
                <div class="row mb-2">
                    <div class="col-md-2 col-sm-6 col-12">
                        <div class="info-box shadow-lg">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-number">{{ number_format($nb_devis_prestations, 0, ",",".") }}</span>
                            </div>
                            <!-- /.info-box-content -->
                        </div>
                        <!-- /.info-box -->
                    ...
                    <div class="col-md-4 col-sm-6 col-12">
                        <div class="info-box shadow-lg">
                            ...
                            <div class="info-box-content">
                                <span class="info-box-text">Montant des devis</span>
                                <span class="info-box-number">{{ number_format($mt_devis_prestations, 0, ",",".") }}</span>
                            </div>
                            <!-- /.info-box-content -->
                        </div>
                        <!-- /.info-box -->
                    ...
                    <div class="col-md-3 col-sm-6 col-12">
                        <div class="info-box shadow-lg">
                            ...
                            <div class="info-box-content">
                                <span class="info-box-text">Moyenne des devis</span>
                                <span class="info-box-number">{{ number_format($moyenne_devis_prestations, 0, ",",".") }} F.CFA</span>
                            </div>
                            <!-- /.info-box-content -->
                        </div>
                        <!-- /.info-box -->
                    ...
                    <div class="col-md-3 col-sm-6 col-12">
                        <div class="info-box shadow-lg">
                            ...
                            <div class="info-box-content">
                                <span class="info-box-text">Meilleur Devis</span>
                                <span class="info-box-number">{{ number_format($best_mountant_devis, 0, ",",".") }} F.CFA</span>
                            </div>
                            <!-- /.info-box-content -->
                        </div>
                        <!-- /.info-box -->
    ...
    <script>
        $(function () {
            var table = $('#table').DataTable({
                ...
                autoWidth: true,
                responsive: true, */
                ajax: "{{ route('tracking-devis-des-prestations') }}",
                columns: [
                    /* {data: 'id', name: 'id'}, */
        ...
        function addForm() {
            var url = window.location.origin+'/admin/transactions/ventes/nouveau/';
        ...
        function deleteData(id) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax(
                    {
                        url : "{{ url('api/annulation-prestation') . '/' }}" + id,
                        type: 'POST',
                        data: {
                            "id": id,
                            "_token": token,
                        ...
                        success: function (){
                            Swal.fire(
                                'Annulation !',
                                'Prestation annulée avec succès, Ristourne générée et à régler !.',
                                'success'
                            )
                            table.draw();
                        },
