                ...
                <div class="row mb-2">
                    <div class="col-md-6 col-sm-6 col-12">
                        <div class="info-box shadow-lg">
                            <span class="info-box-icon bg-maroon"><i class="bi bi-shield-shaded"></i></span>

                            <div class="info-box-content">
                                <span class="info-box-text">Roles</span>
                                <span class="info-box-number">{{ number_format($nb_roles, 0, ",",".") }}</span>
                            </div>
                            <!-- /.info-box-content -->
                        </div>
                        <!-- /.info-box -->
...
@push('scripts')
    ...
    <script>
        ...
        function add() {
            ...
            $('#ajax-form').attr("action", "{{ route('roles.store') }}");
            $('#formulaire-modal').find('.modal-title').text('Créer un nouveau rôle');
        }
        ...
        function showData(id){
            ...
            $.ajax({
                ...
                success: function(row){
                    ...
                    $('.modal-title-show').text('Visualisation Role');

                    $('#id-show').val(row.data.id);
                    /* $('.info-box-number').html(data.role); */
                    $('#role-show').val(row.data.role);
                },
                error: function(){
        ...
        function editData(id){
            ...
            $.ajax({
                ...
                success: function(row){
                    ...
                    console.log(data);
                    $('#modal-form').modal('show');
                    $('.modal-title').text('Modification Rôle');
