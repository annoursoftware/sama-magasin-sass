<div class="modal fade" id="modal-form-view-detail-encaissement" data-backdrop="static">
                      ...
                      <div class="card-body">
                        <div class="row">
                          <div class="col-md-5 col-sm-12 col-12">
                            <div class="form-group">
                              <label for="dv_mode_encaissement">Mode encaissement</label><br>
                              <input type="text" class="form-control rounded-0" id="dv_mode_encaissement" readonly />
                            </div>
                          </div>

                          <div class="col-md-7 col-sm-12 col-12">
                            <div class="form-group">
                              <label for="dv_lieu_encaissement">Lieu encaissement</label>
                              <input type="text" class="form-control rounded-0" id="dv_lieu_encaissement" readonly />
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="row">
                          <div class="col-sm-6 col-6">
                            <div class="form-group">
                              <label for="dv_ref_encaissement">Référence encaissement <code data-toggle="tooltip" title="modifiez le champ et quittez le afin de le modifier définitivement !"><strong><i class="bi bi-info-circle"></i></strong></code></label>
                              <input type="text" class="form-control rounded-0" id="dv_ref_encaissement" />
                            </div>
                          </div>

                          <div class="col-sm-6 col-6">
                            <div class="form-group">
                              <label for="dv_montant">Montant encaissement <code data-toggle="tooltip" title="modifiez le champ et quittez le afin de le modifier définitivement !"><strong><i class="bi bi-info-circle"></i></strong></code></label>
