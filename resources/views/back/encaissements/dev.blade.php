                    ...
                    <div class="col-md-6 col-sm-6 col-12">
                        <div class="info-box shadow-lg">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-number">{{ number_format($nb_encaissements, 0, ",",".") }} / {{ number_format($mt_encaissements, 0, ",",".") }} F.CFA</span>
                            </div>
                            <!-- /.info-box-content -->
                        </div>
                        <!-- /.info-box -->
                    ...
                    <div class="col-md-6 col-sm-6 col-12">
                        <div class="info-box shadow-lg">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-number">{{ number_format(($nb_ventes+$nb_prestations), 0, ",",".") }} / {{ number_format(($mt_ventes+$mt_prestations), 0, ",",".") }} F.CFA</span>
                            </div>
                            <!-- /.info-box-content -->
                        </div>
                        <!-- /.info-box -->
    ...
    <script>
        $(function () {
            var table = $('#table').DataTable({
                ...
                autoWidth: true,
                responsive: true, */
                ajax: "{{ route('encaissements.index') }}",
                columns: [
                    /* {data: 'id', name: 'id'}, */
                    { data: 'num_encaissement', name: 'num_encaissement' },
                    { data: 'encaissements', name: 'encaissements',
                    ...
                    { data: 'etat', name: 'etat',
                        render: function(data, type, row) {
                            if(row.encaissements == row.montant){
