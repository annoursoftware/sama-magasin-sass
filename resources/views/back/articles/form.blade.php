                ...
                <div class="row mt-4">
                    <div class="col-sm-5">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control rounded-0" name="article" id="article" required placeholder="L'article" />
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control rounded-0" name="caracteristiques" id="caracteristiques" required placeholder="Les caracteristiques de l'article" />
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                          ...
                          <select class="custom-select rounded-0" id="marque" name="marque_id" required >
                            <option value="">*** Choix ***</option>
