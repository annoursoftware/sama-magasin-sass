                ...
                <div class="row mb-2">
                    ...
                    <div class="col-md-4 col-sm-6 col-12">
                        <div class="info-box shadow-lg">
                            ...
                            <div class="info-box-content">
                                <span class="info-box-text">Montant des Productions</span>
                    ...
                    <div class="col-md-3 col-sm-6 col-12">
                        <div class="info-box shadow-lg">
                            ...
                            <div class="info-box-content">
                                <span class="info-box-text">Meilleure Production</span>
        ...
        $(function () {
            var table = $('#table').DataTable({
                ...
                columns: [
                    ...
                    { data: 'qte_produite', name: 'qte_produite',
