...
@section('title', 'Productions - Opérations')
        ...
        <section class="content-header">
            <div class="container-fluid">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-md-2 col-sm-6 col-12">
                        <div class="info-box shadow-lg">
                            <span class="info-box-icon bg-maroon"><i class="bi bi-upc-scan"></i></span>

                            <div class="info-box-content">
                                <span class="info-box-text">Produits produits</span>
                                <span class="info-box-number">{{ number_format($cumul_article_detail_achats, 0, ",",".") }}</span>
                            </div>
                            <!-- /.info-box-content -->
                        </div>
                        <!-- /.info-box -->
                    ...
                    <div class="col-md-2 col-sm-6 col-12">
                        <div class="info-box shadow-lg">
                            <span class="info-box-icon bg-maroon"><i class="bi bi-basket-fill"></i></span>

                            <div class="info-box-content">
                                <span class="info-box-text">Quantité</span>
                                <span class="info-box-number">{{ number_format($cumul_quantite_detail_achats, 0, ",",".") }}</span>
                            </div>
                            <!-- /.info-box-content -->
                        </div>
                        <!-- /.info-box -->
                    ...
                    <div class="col-md-3 col-sm-6 col-12">
                        <div class="info-box shadow-lg">
                            ...
                            <div class="info-box-content">
                                <span class="info-box-text">Cout de Productions</span>
                                <span class="info-box-number">{{ number_format($mt_achats, 0, ",",".") }} FCFA</span>
                            </div>
                            <!-- /.info-box-content -->
                        </div>
                        <!-- /.info-box -->
                    ...
                    <div class="col-md-3 col-sm-6 col-12">
                        <div class="info-box shadow-lg">
                            ...
                            <div class="info-box-content">
                                <span class="info-box-text">Montant des décaissements</span>
                                <span class="info-box-number">{{ number_format($mt_decaissements, 0, ",",".") }} FCFA</span>
                            </div>
                            <!-- /.info-box-content -->
                        </div>
                        <!-- /.info-box -->
    ...
    <script>
        $(function () {
            var table = $('#table').DataTable({
                ...
                autoWidth: true,
                responsive: true, */
                ajax: "{{ route('operations-de-production') }}",
                columns: [
                    /* {data: 'id', name: 'id'}, */
                    {data: 'num_production', name: 'num_production'},
                    /* { data: 'status_production', name: 'status_production',
